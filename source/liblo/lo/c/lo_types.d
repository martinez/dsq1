...
enum LO_DISABLE = 0;  //!< Disable a boolean option.
enum LO_ENABLE = 1;   //!< Enable a boolean option.
...
alias lo_server_thread_t *lo_server_thread;
 ...
 */
alias void function(int num, const(char) *msg, const(char) *where) lo_err_handler;
 ...
 */
alias int function(const(char) *path, const(char) *types,
                   lo_arg **argv, int argc, lo_message msg,
                   void *user_data) lo_method_handler;
 ...
 */
alias int function(lo_timetag time, void *user_data) lo_bundle_start_handler;
 ...
 */
alias int function(void *user_data) lo_bundle_end_handler;
