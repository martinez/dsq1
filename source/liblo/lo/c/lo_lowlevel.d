 ...
 */
int lo_message_add(string file = __FILE__, int line = __LINE__, A...)
    (lo_message m, const(char) *types, A a)
{
  return lo_message_add_internal(m, file.toStringz, line, types, a, LO_MARKER_A, LO_MARKER_B);
}
 ...
 * \return Less than 0 on failure, 0 on success.
 */
int lo_message_add_midi(lo_message m, uint8_t[4] a);
 ...
 */
uint lo_bundle_count(lo_bundle b);
 ...
 */
char *lo_get_path(void *data, Signed!size_t size);
